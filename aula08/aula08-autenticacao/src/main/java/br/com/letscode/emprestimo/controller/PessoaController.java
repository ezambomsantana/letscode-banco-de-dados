...
public class PessoaController {
    ...
    @GetMapping("/buscadsl")
    public Page<PessoaDTO> buscaPessoaDsl(
            @QuerydslPredicate(root = Pessoa.class) Predicate predicate,
            Pageable pageable) {
        return pessoaService.queryPessoaPredicate(predicate, pageable);
    }
